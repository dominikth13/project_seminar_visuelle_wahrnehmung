...
Die erste Hypothese, welcher nach Bildkompression und Wahrnehmung der Qualität in keinem linearen Zusammenhang zu einander stehen, konnte durch den Versuch bestätigt werden. Die Verläufe der Graphen in der Zusammenfassenden Darstellung aller Testpersonen zu den einzelnen Bilder zeigen eindeutig keinen linearen Verlauf. Sie zeichnen sich durch einen progressiven Verlauf mit negativer Steigung, also einer zuerst geringen negativen Steigung, welche dann im Verlauf immer stärker zunimmt, aus. Bei den Bilder 5,6 und 7 nähert sich der Graph am ehesten einem linearen Verlauf an. Dies könnte, wie zuvor unter dem Punkt [Analyse der Ausreißer](#analyse-der-ausreißer) beschrieben, an dem fehlenden Fokus der Bilder liegen. Bild 7 kann hier ebenfalls dazugezählt werden. Die besagten Bilder haben durch den fehlenden Fokus über den ganzen Bildbereich einen höheren Detailgrad. Eine mögliche zukünftige Forschungsfrage wäre hier, ob ein höherer Detailgrad, bzw. ein fehlender Fokus, zu einem linearerem Zusammenhang zwischen Bildkompression und Wahrnehmung der Qualität führt.
